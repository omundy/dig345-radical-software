...
<CustomAside type="inclass">
1. Instructor: [Create a test API from scratch to learn Express basics](https://omundy.github.io/learn-javascript/topics/node-express/slides.html). Show examples 
1. Continue this [tutorial to work with a more complete project](https://criticalwebdesign.github.io/wiki/chapter-09/9-4-bad-password-api/).
