...
Astro supports several types of [integrations](https://docs.astro.build/en/guides/integrations-guide/) to import components in [various languages](https://docs.astro.build/en/guides/framework-components/). Follow steps below to add a [svelte integration](https://docs.astro.build/en/guides/integrations-guide/svelte/)
