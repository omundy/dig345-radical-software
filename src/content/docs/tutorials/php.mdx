---
title: PHP
description: PHP is a server-side scripting language that is primarily used to make dynamic websites.
# draft: true
---
...
- Facebook, Canva, Slack, Wikipedia are all (originally) written with PHP
- [Web scraping](https://www.scrapingbee.com/blog/web-scraping-php/)
- [Connect to MySQL database](https://www.w3schools.com/php/php_mysql_intro.asp)
- [Install Wordpress](https://wordpress.org/documentation/article/how-to-install-wordpress/)
