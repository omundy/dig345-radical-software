...
- Click the REPL button to open any example in the interactive [Strudel REPL](https://strudel.cc) (Read-Eval-Print Loop), then continue on for a tutorial.
...
2. This example creates a synthesizer to play tones.  <button class="btn tonejs1"><Icon type="play" /></button> 
...
3. This example will play three notes in succession. <button class="btn tonejs2"><Icon type="play" /></button>
...
4. This example uses Tone.js oscillators to change the frequency of signals in real time. <button class="btn tonejs3"><Icon type="play" /></button>
...
- Codepen [Basic Tone.js starter](https://codepen.io/owenmundy/pen/ZYOdWrV?editors=1010), [More Tone.js examples on Codepen](https://codepen.io/owenmundy/pen/raLoOro?editors=0010), [Tone.js + AudioKeys](https://codepen.io/owenmundy/pen/PwGYpxg?editors=1011)
...
- [add instruments to Tone.js](https://github.com/Tonejs/Tone.js/issues/111)
- Export sound as analog files
  - Tutorial: [Tone.js & CodePen Part 07: Recording Tone in an Audio File](https://www.youtube.com/watch?v=VHCv3waFkRo) ([example](https://codepen.io/jak_e/pen/QVqgBE/?editors=1010))
  - [MediaRecorder](https://developer.mozilla.org/en-US/docs/Web/API/MediaRecorder) [blob](https://developer.mozilla.org/en-US/docs/Web/API/Blob/Blob)
  - [My version](https://codepen.io/owenmundy/pen/WNVjWWO?editors=1010) 
- <a href="https://codepen.io/owenmundy/pen/WNVjWWO">Record tone in audio file</a>
